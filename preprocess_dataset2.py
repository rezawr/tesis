...
df = pd.read_csv('datasets/dataset2/Dataset Twitter Fix - Indonesian Sentiment Twitter Dataset Labeled (1).csv', encoding='latin-1')
...
def main():
    ...
    print(df['Tweet'])
    print(df.head(5))
    df.to_csv('datasets/dataset2/preprocess_data.csv')
