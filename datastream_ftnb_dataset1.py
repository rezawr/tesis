...
if __name__ == "__main__":
    ...
    pd.DataFrame(result).to_csv('resultftnb/performance.csv', index=False)
    pd.DataFrame(performance).to_csv('resultftnb/resource.csv', index=False)
    pd.DataFrame(total_thread).to_csv('resultftnb/total_thread.csv', index=False)
    print("Done!")
    print(result)
    print(performance)